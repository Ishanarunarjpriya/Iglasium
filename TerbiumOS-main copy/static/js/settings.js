...
const dropTextSE = document.querySelector(".SE");
switch(localStorage.getItem("se")) {
    case "se_google":
        dropTextSE.innerHTML = "Google";
        break;
    case "se_bing":
        dropTextSE.innerHTML = "Bing";
        break;
    case "se_yahoo":
        dropTextSE.innerHTML = "Yahoo";
        break;
    case "se_ddg":
        dropTextSE.innerHTML = "DuckDuckGo";
        break;
    case "se_searx":
        localStorage.setItem("se", "se_ddg");
        dropTextSE.innerHTML = "DuckDuckGo";
        break;
    default:
        localStorage.setItem("se", "se_ddg");
...
for (let i = 0; i < dropBtns.length; i++) {
    ...
    for (let ie = 0; ie < dropOptions.length; ie++) {
        dropOptions[ie].addEventListener("click", () => {
            ...
            localStorage.setItem(dropOptions[ie].getAttribute("data-former"), `${dropOptions[ie].getAttribute("data-option")}`);
        });
